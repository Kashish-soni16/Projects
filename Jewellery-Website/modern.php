...
<head>
    ...
    <title>Kashish Jewels | Modern</title>
...
<body>
    <div class="menu">
        <ul type="none" class="menu-items">
            ...
            <li><a href="home_page"><img src="img7.png" class="logo"></a></li>
            <li><a href="Traditional.php">Traditional</a></li>
            <li><a href="account.php">Account</a></li>
        </ul> 
    </div>
    <div class="face">
        <img src="img35.jpeg" class="img">
    </div>
        ...
        <?php
            ...
            $sql = "SELECT name, price, img FROM modern";
